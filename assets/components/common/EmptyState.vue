<template>
  <!--
    The answer for a surface that has nothing to show: a muted glyph, one line saying
    what is missing, one line saying what to do about it. It sits in the room the
