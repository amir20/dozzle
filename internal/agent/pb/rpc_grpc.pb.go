...
func (c *agentServiceClient) CheckImageUpdate(ctx context.Context, in *CheckImageUpdateRequest, opts ...grpc.CallOption) (*CheckImageUpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentService_CheckImageUpdate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentService_CheckImageUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AgentServiceServer).CheckImageUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_CheckImageUpdate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).CheckImageUpdate(ctx, req.(*CheckImageUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AgentService_CheckImageUpdate_Handler,
		},
		{
