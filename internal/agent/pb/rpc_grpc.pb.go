...
type AgentService_LogsBetweenDatesClient interface {
	Recv() (*LogsBetweenDatesResponse, error)
	grpc.ClientStream
}
...
func (x *agentServiceLogsBetweenDatesClient) Recv() (*LogsBetweenDatesResponse, error) {
	m := new(LogsBetweenDatesResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type AgentService_LogsBetweenDatesServer interface {
	Send(*LogsBetweenDatesResponse) error
	grpc.ServerStream
}
...
func (x *agentServiceLogsBetweenDatesServer) Send(m *LogsBetweenDatesResponse) error {
	return x.ServerStream.SendMsg(m)
}
